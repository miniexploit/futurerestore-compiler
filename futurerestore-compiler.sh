...
DIRECTORIES=("libimobiledevice-glue" "libimobiledevice" "libplist" "libusbmuxd" "libirecovery" "libgeneral" "libfragmentzip" "libinsn" "img4tool" "liboffsetfinder64" "libipatcher")
